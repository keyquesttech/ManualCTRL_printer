...
SECTION_SCHEMA: dict[str, dict[str, dict[str, Any]]] = {
    ...
    "firmware": {
        ...
        "invert_bed": _bool("Invert bed direction", help="Flip bed rotation direction to match wiring"),
        "invert_z": _bool("Invert Z direction", help="Flip Z axis direction to match wiring"),
        "invert_e": _bool("Invert extruder direction", help="Flip extruder direction to match wiring"),
    },
    "machine": {
    ...
    "pins": {
        "bed_step": _str("Bed step pin", help="e.g. PB10"),
        "bed_dir": _str("Bed dir pin"),
        "bed_enable": _str("Bed enable pin"),
        "bed_dir_invert": _bool("Bed dir invert"),
        "z_step": _str("Z step pin"),
        "z_dir": _str("Z dir pin"),
        "z_enable": _str("Z enable pin"),
        "z_dir_invert": _bool("Z dir invert"),
        "e_step": _str("Extruder step pin"),
        "e_dir": _str("Extruder dir pin"),
        "e_enable": _str("Extruder enable pin"),
        "e_dir_invert": _bool("Extruder dir invert"),
        "tmc_rx": _str("TMC UART RX pin"),
        "tmc_tx": _str("TMC UART TX pin"),
        "tmc_bed_addr": _int("TMC bed driver address (0–3)"),
        "tmc_z_addr": _int("TMC Z driver address"),
        "tmc_e_addr": _int("TMC E driver address"),
        "heater": _str("Hotend heater pin"),
        "thermistor": _str("Thermistor pin"),
        "fan_part": _str("Part cooling fan pin"),
        "fan_hotend": _str("Hotend fan pin"),
        "z_endstop": _str("Z endstop pin"),
        "beeper": _str("Beeper pin"),
    },
    "macros": {
